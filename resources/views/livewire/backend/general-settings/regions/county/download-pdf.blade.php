            ...
            <div class="panel-body">
                <div class="row">
                    <div class="p-3 text-center">
                        ...
                        <br>
                        <span>                           <strong><h2 style="text-transform: uppercase;border-bottom:5px solid #1f3c6b;padding:5px">REGION (COUNTIES)</h2></strong>
                        </span>
                    </div>
                    <div class="col-lg-12" >
                        <div class="card card-outline card-success applicant">
                            ...
                            <div class="card-body">
                                <table class="table table-bordered table-striped" style="padding: 20px">
                                    ...
                                    <tbody>
                                        @forelse ($showAll['downloadCounty'] as $count => $county)
                                            <tr>                     
                                                <td style="width: 5%">{{ ++$count}}</td>
                                                <td style="width: 10%">{{ $county->name }}</td>
                                                
                                                <td style="width: 50%;text-transform: capitalize" >

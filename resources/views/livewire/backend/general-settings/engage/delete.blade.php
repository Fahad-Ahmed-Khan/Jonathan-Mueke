<div wire:ignore.self class="shadow modal fade" id="delete-request-modal" tabindex="-1" role="dialog"
    aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <strong class="modal-title" title="Executive Role" id="exampleModalLabel"><i class="fa fa-user-tag"></i>Donation Delete Confirmation</strong>

    ...
    {{-- =================================CREATE FORM==================== --}}
<div wire:ignore.self class="shadow modal" id="editEvents" tabindex="-1" role="dialog"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12" wire:ignore>
                            <div class="form-group input-group-sm">
                                ...
                                <textarea id="editEventDescription" class="form-control @error('description') is-invalid @enderror" wire:model="description" cols="10" rows="5" autofocus>

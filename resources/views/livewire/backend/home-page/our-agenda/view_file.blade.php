        ...
        <div class="modal-content">
            <div class="modal-header">
                <strong class="modal-title" title="Document" id="exampleModalLabel">
                   You've opened. [ <strong>>{{ $agenda_title }} ]</strong>
                </strong>
            ...
            <div class="modal-body card-background">
                    <!-- ----session response -------- -->
                    @if (session()->has('agenda_image_updation'))
                        <strong class="text-success"> 👍 {{ session('agenda_image_updation')}} <i class="fa fa-check"></i></strong>
                    @endif

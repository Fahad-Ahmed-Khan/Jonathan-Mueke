    ...
    {{-- =================================CREATE FORM==================== --}}
    <div wire:ignore.self class="shadow modal" id="addStory" tabindex="-1" role="dialog"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group input-group-sm">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" wire:model="description" input="description" cols="10" rows="8" autofocus></textarea>
                                    @error('description')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>

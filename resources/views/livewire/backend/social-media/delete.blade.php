<div wire:ignore.self class="shadow modal fade" id="elete-socialmedia-modal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body card-background">
                <strong>You're about to delete  <strong class="text-danger">{{ $header }} </strong> ? This Action is irreversible</strong>
            </div>
